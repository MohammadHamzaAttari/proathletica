            ...
            <div key={editor.name} id={editor.id} className="scroll-mt-24 space-y-4">
              ...
              <div className="space-y-1">
                <div className="flex items-center justify-between">
                  <h3 className="text-lg font-black uppercase tracking-tight text-white hover:text-trust-blue transition-colors">
                    <Link href={`/author/${editor.id}`}>{editor.name}</Link>
                  </h3>
                  {editor.linkedin && (
